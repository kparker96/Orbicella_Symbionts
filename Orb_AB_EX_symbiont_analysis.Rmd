...
```{r}
Ofav_combos <- Ofav %>%
  select(Sample.Name, depth, region, A = Symbiodinium, B = Breviolum, C = Cladocopium, D = Durusdinium) %>%
...
uniform_intersections <- euler(c("A" = 1, "B" = 1, "C" = 2,"D" = 1,
                                 "A&B" = 24, "A&C" = 19, "A&D" = 17, "B&C" = 33, "B&D" = 40, "C&D" = 37))
